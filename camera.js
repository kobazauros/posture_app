import { MAX_CAMERA_ZOOM, MIN_CAMERA_ZOOM, state } from './state.js?v=6';
import { initSensors } from './sensors.js?v=6';
import { initDetector, startDetectionLoop, stopDetectionLoop } from './detector.js?v=6';
