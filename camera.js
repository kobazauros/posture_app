import { MAX_CAMERA_ZOOM, MIN_CAMERA_ZOOM, state } from './state.js?v=8';
import { initSensors } from './sensors.js?v=8';
import { initDetector, startDetectionLoop, stopDetectionLoop } from './detector.js?v=8';
