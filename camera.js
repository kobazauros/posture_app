import { MAX_CAMERA_ZOOM, MIN_CAMERA_ZOOM, state } from './state.js?v=21';
import { initSensors } from './sensors.js?v=21';
import { initDetector, startDetectionLoop, stopDetectionLoop } from './detector.js?v=21';
