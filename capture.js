...
import { sendPhotosToServer } from './upload.js?v=13';
import { getFigureStatus } from './detector.js?v=13';
import { bindTimerButton, handleCaptureWithTimer } from './timer.js?v=13';
/**
