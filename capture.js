import { state, stepLabels } from './state.js?v=12';
import { sendPhotosToServer } from './upload.js?v=12';
import { getFigureStatus } from './detector.js?v=12';
import { bindTimerButton, handleCaptureWithTimer } from './timer.js?v=12';
/**
